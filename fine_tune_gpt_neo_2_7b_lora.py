#!/usr/bin/env python3
"""
GPT-Neo 2.7B Medical AI Fine-tuning Script with LoRA

This script fine-tunes EleutherAI GPT-Neo 2.7B using LoRA (Low-Rank Adaptation) on your medical research database.
GPT-Neo 2.7B is an open model that should work well on your M3 Ultra system.
"""
...
class GPTNeo27BLoRAFineTuner:
    ...
    def setup_lora_config(self):
        """Setup LoRA configuration for GPT-Neo 2.7B."""
    ...
    def fine_tune(self, model_name: str, max_samples: int = 1200):
        ...
        logger.info(f"Starting GPT-Neo 2.7B LoRA fine-tuning...")
        ...
        try:
            ...
            training_args = TrainingArguments(
                output_dir="./gpt-neo-2.7b-medical-lora",
            ...
            trainer.save_model()
            tokenizer.save_pretrained("./gpt-neo-2.7b-medical-lora")
            
            logger.info("LoRA fine-tuning completed! Model saved to ./gpt-neo-2.7b-medical-lora")
...
def main():
    """Main function to fine-tune GPT-Neo 2.7B with LoRA."""
    logger.info("🏥 GPT-Neo 2.7B Medical AI LoRA Fine-tuning")
    logger.info("=" * 60)
    ...
    if device == "cpu":
        ...
        logger.info("GPT-Neo 2.7B with LoRA should work well with your 96GB RAM.")
    else:
    ...
    fine_tuner = GPTNeo27BLoRAFineTuner()
    
    # Determine training parameters
    max_samples = 1200  # Use 1200 samples for LoRA training
    ...
    if success:
        ...
        logger.info("Model saved to: ./gpt-neo-2.7b-medical-lora/")
        ...
        try:
            ...
            generator = pipeline(
                "text-generation",
                model="./gpt-neo-2.7b-medical-lora",
                tokenizer="./gpt-neo-2.7b-medical-lora",
